...
def resume(request):
    ...
    return render(request, "website/pages/resume.html", context=context)
...
class PortfolioExampleListView(generic.ListView):
    ...
    template_name = "website/pages/portfolio.html"
...
class CertificateListView(generic.ListView):
    model = Certificate
    template_name = "website/pages/certificates.html"
